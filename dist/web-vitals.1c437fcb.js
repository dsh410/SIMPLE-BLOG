      ...
      function (require, module, exports) {
        ...
        var e,
          ...
          a = function (e, t) {
            return {
              ...
              id: "v1-"
                .concat(Date.now(), "-")
                .concat(
                  Math.floor(8999999999999 * Math.random()) + 1000000000000
                ),
            };
          },
          r = function (e, t) {
          ...
          f = function (e, t, n) {
            ...
            return function () {
              t.value >= 0 &&
                (n || u.has(t) || "hidden" === document.visibilityState) &&
                ((t.delta = t.value - (i || 0)),
          ...
          y = function (i, a) {
            e ||
              ((e = a), (t = i), (n = new Date()), w(removeEventListener), g());
          },
          g = function () {
            if (t >= 0 && t < n - S) {
              var a = {
          ...
          E = function (e) {
            if (e.cancelable) {
              var t =
                (e.timeStamp > 1000000000000 ? new Date() : performance.now()) -
                e.timeStamp;
              "pointerdown" == e.type
                ? (function (e, t) {
                    var n = function () {
          ...
          T = function (e, t) {
            ...
            if (p) {
              ...
              var v = function () {
                u.has(s) ||
                  (p.takeRecords().map(m), p.disconnect(), u.add(s), n());
              };
